...
describe("sortTasksForPlanning", () => {
  ...
  it("within phase: dated tasks before undated, then sortOrder", () => {
    const undatedEarly = task({ id: "u0", title: "U0", roomId: "r", sortOrder: 0, startDate: null });
    const dated = task({ id: "d", title: "D", roomId: "r", sortOrder: 99, startDate: "2025-01-02" });
    const undatedLate = task({ id: "u1", title: "U1", roomId: "r", sortOrder: 1, startDate: null });
  ...
  it("within phase with dates: ascending by startDate", () => {
    const t2 = task({ id: "2", title: "B", roomId: "r", startDate: "2025-02-01", sortOrder: 0 });
    const t1 = task({ id: "1", title: "A", roomId: "r", startDate: "2025-01-01", sortOrder: 1 });
